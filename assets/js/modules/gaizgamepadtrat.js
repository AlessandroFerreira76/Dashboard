class GaizGamePad {
	...
	axesPedal(Gc2Y, Gc3Y) {
		console.log("🚀 ~ file: gaizvisualstatus.js ~ line 482 ~ VisualStatus ~ axesPedal ~ Gc3Y", Gc3Y)
		console.log("🚀 ~ file: gaizvisualstatus.js ~ line 482 ~ VisualStatus ~ axesPedal ~ Gc2Y", Gc2Y)
		if (Gc2Y > 0) {
