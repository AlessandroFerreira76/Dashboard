...
!(function (t) {
    ...
    t('[data-toggle="fullscreen"]').on("click", function (e) {
        ...
        t(".right-bar-inc-toggle").on("click", function (e) {
            // console.log("Enter");
            t("body").toggleClass("right-bar-inc-enabled");
        }),
        t(document).on("click", "body", function (e) {
            0 < t(e.target).closest(".right-bar-inc-toggle, .right-bar-inc").length || t("body").removeClass("right-bar-inc-enabled");
        }),
        ...
        (function () {
            if (window.sessionStorage) {
                ...
                e ? (t(".right-bar input:checkbox").prop("checked", !1), t("#" + e).prop("checked", !0), s(e)) : sessionStorage.setItem("is_visited", "dark-mode-switch");
            }
