import { GaizGamePad } from "./modules/gaizgamepadcami.js"
...
// FUNCOES
{
	...
	var AtualizaJoysticks = function (controllers, m) {
		...
		bE2 = (buttonPressed(controllers[m].buttons[7]) == 1); //diagonal esquerdo
		bE3 = (buttonPressed(controllers[m].buttons[6]) == 1); //baixo
